...
class rnnpp(nn.Module):
    ...
    def __init__(self, marker_type='real', marker_dim=31, time_dim=2, hidden_dim=128, x_given_t=False, gamma = 1. ):
        super().__init__()
        """
            Input:
    ...
    def _forward(self, x, t, mask):
        ...
        time_log_likelihood, mu_time = self.compute_point_log_likelihood(
            hidden_states, t)
        with torch.no_grad():
