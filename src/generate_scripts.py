...
gpu_partitions = {
    "book_order": line2_m40_lo,
    "so": line2_x_lo,
    "lastfm": line2_x_lo,
    "retweet": line2_m40_lo,
    "meme": line2_x_lo,
    "mimic2": line2_ti_lo,
    }
...
def main():
    ...
    for outer_idx in range(outer_total_params):
        ...
        list_of_command = [line1, gpu_partitions[dataset], line3]
        ...
        write_to_file(script_name, list_of_command , 'w')
